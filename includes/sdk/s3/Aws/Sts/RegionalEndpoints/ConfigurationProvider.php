...
namespace Dudlewebs\WPMCS\s3\Aws\Sts\RegionalEndpoints;
...
use Dudlewebs\WPMCS\s3\Aws\Sts\RegionalEndpoints\Exception\ConfigurationException;
...
class ConfigurationProvider extends AbstractConfigurationProvider implements ConfigurationProviderInterface
{
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use($profile, $filename) {
            ...
            $data = \Dudlewebs\WPMCS\s3\Aws\parse_ini_file($filename, \true);
            if ($data === \false) {
