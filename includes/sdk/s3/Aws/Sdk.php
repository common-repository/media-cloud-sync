...
class Sdk
{
    ...
    public function createClient($name, array $args = [])
    {
        ...
        $client = "Dudlewebs\\WPMCS\\s3\\Aws\\{$namespace}\\{$namespace}Client";
    ...
    public function createMultiRegionClient($name, array $args = [])
    {
        ...
        $service = manifest($name);
        $namespace = $service['namespace'];
        $klass = "Dudlewebs\\WPMCS\\s3\\Aws\\{$namespace}\\{$namespace}MultiRegionClient";
        $klass = \class_exists($klass) ? $klass : 'Dudlewebs\\WPMCS\\s3\\Aws\\MultiRegionClient';
