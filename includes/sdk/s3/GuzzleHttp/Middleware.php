...
use Dudlewebs\WPMCS\s3\GuzzleHttp\Cookie\CookieJarInterface;
...
use Dudlewebs\WPMCS\s3\Psr\Log\LoggerInterface;
/**
        ...
        return function (callable $handler) {
            return function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('Dudlewebs\\WPMCS\\s3\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
